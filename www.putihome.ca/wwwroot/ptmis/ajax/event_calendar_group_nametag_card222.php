...
function item_photo($i, $j, $info) {
	...
	global $words;
	global $admin_user;
	$html_ret .= '<div style="position:relative; float:left; border:1px dotted #red; display:inline-block; margin:1px; text-align:left; width:320px; height:200px; overflow:hidden;">';
	//$html_ret .= '<div style="position:relative; float:left; border:1px dotted #666666; display:inline-block; margin:1px; text-align:left; width:320px; height:200px; overflow:hidden;">';
	//$html_ret .= '<img src="/theme/blue/image/background/scard.jpg" style="position:absolute; top:0px; left:0px;" width="367" height="320" />';
	$html_ret .= '<div style="position:absolute;top:5px;width:100%;text-align:center;font-family:Arial;font-size:18px;font-weight:bold;color:#A01E04;overflow:hidden;white-space:nowrap;">' . $info["etitle"] . '</div>';
