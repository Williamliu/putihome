...
function item($i, $j, $info) {
	...
	if( cTYPE::iifcn($words["name"]) ) {
		$html_ret .= '<td valign="middle" align="right" style="width:60px;white-space:nowrap;"><span style="font-size:22px;font-family:隶书;">' . $words["name"] . '</span></td>';
		...
		$html_ret .= '<td valign="middle" align="right" style="width:60px;white-space:nowrap;"><span style="font-size:16px;font-family:隶书;">' . $words["name"] . '</span></td>';
		$html_ret .= '<td valign="middle" align="center"><span style="font-size:46px; font-weight:bold; margin-left:-30px;font-family:隶书;">' . $info["name"] . '&nbsp;</span></td>';
	}
...
function item_photo($i, $j, $info) {
    ...
    if($info["leader"]=="1" || $info["volunteer"]=="1") {
		...
		if( cTYPE::iifcn($info["name"]) ) {
			...
			$html_ret .= '<span style="font-size:36px;font-weight:bold;font-family:隶书;">' . $info["name"] . '&nbsp;</span>';
		}
		...
		if( cTYPE::iifcn($info["name"]) ) {
			...
			$html_ret .= '<span style="font-size:32px;font-family:隶书; font-weight:bold;">' . $info["name"] . '&nbsp;</span>';
		}
