...
try {
	...
	while( $row = $db->fetch($result)) {
		...
		$rows[$cnt]["dharma_pinyin"] 		= $row["dharma_pinyin"]?cTYPE::gstr($row["dharma_pinyin"]):'';
		$rows[$cnt]["temp_dharma_name"]		= $row["temp_dharma_name"]?cTYPE::gstr($row["temp_dharma_name"]):($rows[$cnt]["dharma_name"]?$rows[$cnt]["dharma_name"]:"");
		$rows[$cnt]["temp_dharma_pinyin"]	= $row["temp_dharma_pinyin"]?cTYPE::gstr($row["temp_dharma_pinyin"]):($rows[$cnt]["dharma_pinyin"]?$rows[$cnt]["dharma_pinyin"]:"");
