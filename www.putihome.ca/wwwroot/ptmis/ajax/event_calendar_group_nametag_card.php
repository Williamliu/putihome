...
try {
	...
	*/
	...
	if($_REQUEST["aflag"]=="1") {
		  $query = "SELECT a.id as enroll_id, a.leader, a.volunteer, a.confirm, a.shelf, b.id, b.id as member_id, b.first_name, b.last_name, b.dharma_name, b.gender, b.email, b.phone, b.cell, b.city, a.group_no,
...
function item($i, $j, $info) {
	...
	$html_ret .= '<div style="display:block;width:100%;height:150px;"><span style="display:inline-block;width:0px;height:100%;vertical-align:middle;"></span>';
	$html_ret .= $photo_html;
	$html_ret .= '</div>';
	$html_ret .= '</td>';
