...
function item_photo($i, $j, $info) {
	...
	$html_ret .= '<div style="position:absolute; top:45px; width:100%; text-align:center; font-family:隶书; font-size:'. $st_size .'px; letter-spacing:' . $st_space. 'px; color:#A01E04; overflow:hidden; white-space:nowrap;">' . cTYPE::gstr($st_title) . '</div>';
    ...
    if($info["leader"]=="1" || $info["volunteer"]=="1") {
		...
		$html_ret .= '<div style="position:absolute; top:95px; padding-left:10px; width:100%; text-align:left; font-family:Arial; overflow:hidden;">';
		$html_ret .= '<table width="100%" border="0" cellpadding="0" cellspacing="0">';

		$html_ret .= '<tr>';
		$html_ret .= '<td rowspan="4" valign="middle" width="120"><div style="display:block;width:100%;height:170px;"><span style="display:inline-block;width:0px;height:100%;vertical-align:middle;"></span>';
		$html_ret .= $photo_html;
		$html_ret .= '</div></td>';
		...
		$html_ret .= '<div style="padding-top:5px; width:100%; text-align:center; font-family:Arial; font-size:16px; color:#A01E04;">' . $info["etitle"] . '</div>';
		...
		$html_ret .= '<tr>';
		$html_ret .= '<td rowspan="3" valign="middle" width="120"><div style="display:block;width:100%;height:170px;"><span style="display:inline-block;width:0px;height:100%;vertical-align:middle;"></span>';
		$html_ret .= $photo_html;
		$html_ret .= '</div></td>';
		$html_ret .= '<td valign="middle" align="center" style="padding-left:-5px;">';
