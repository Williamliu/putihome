...
function item($i, $j, $info) {
	...
	$pdf->SetFont('Big5','',14); 
	$pdf->Text($i*$ww + $ww_offset + 5 , $j*$hh + $hh_offset + 30, cTYPE::tobig5(stripslashes($info["etitle"])) );
	//$pdf->Text($i*$ww + $ww_offset + 5 , $j*$hh + $hh_offset + 30, stripslashes($info["etitle"]) );
	...
	//$pdf->Text($i*$ww + $ww_offset + 16 , $j*$hh + $hh_offset + 48, stripslashes($info["name"]) );
	...
	//$pdf->Text($i*$ww + $ww_offset + 20 , $j*$hh + $hh_offset + 60, stripslashes($info["dharma_name"]) );
