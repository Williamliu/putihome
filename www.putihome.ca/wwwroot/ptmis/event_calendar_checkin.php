...
<!--
<audio controls="controls" autobuffer width="298px" height="45px" id="audiocontrol" autoplay="autoplay">
<source src="<?php echo $CFG["http"]. $CFG["admin_domain"];?>/error.mp3" type="audio/mpeg" />
<source src="<?php echo $CFG["http"]. $CFG["admin_domain"];?>/error.ogg" type="audio/ogg" />
<source src="<?php echo $CFG["http"]. $CFG["admin_domain"];?>/error.wav" type="audio/wav" />
Your web browser doesn't support HTML5. Please try another browser
</audio>
-->
<?php 
...
<div>
	<div style="background-color:#A7CFF4;">
        <input type="button" style="margin-left:2px;" id="btn_back" onclick="back_to_main()" value="<?php echo $words["back to main"];?>" />
    ...
    <div style="background-color:#F3E5E0; height:260px;">
