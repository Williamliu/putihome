		...
		$(function(){
			...
			aj = new LWH.AjaxUpload({
				...
				imgCutDone: function(req) {
					$("#member_photo").attr("src",  "ajax/lwhUpload_image.php?ts=" + req.data.ts + "&size=small&img_id=" + req.data.ref_id);
					$("#member_photo").attr("width",120).css({"left":"0px", "top":"0px", "width":"120px"});
				},
...
<div class="lwhZoom">
    <img id="member_photo" src="" width="120" height="160" maxwidth="2048" />
</div>
