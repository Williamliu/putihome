    	...
    	<table border="0" cellpadding="4" cellspacing="0" width="100%">
        	<tr>
            	...
            	<td width="50%" valign="top">
                        <!-- registrate accout -->                      
                        <div class="content-box" style="width:100%;">
                            <div class="content-box-head"><?php echo $words["register as administrator"]?></div>
                            <div class="content-box-content">
                                            <form name="frm_new">
                                            <table border="0" cellpadding="2" cellspacing="0">
                                                <tr>
                                                ...
                                                <tr>
                                                    <td class="line" colspan="2" align="right">
                                                    	<span style="color:red;"><?php echo $words["login info tips"]?>
                                                        </span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td valign="top" class="title"><?php echo $words["email"]?>: <span class="required">*</span></td>
                                                    <td>
                                                ...
                                                <tr>
                          						...
                          						<tr>
                                                    <td class="title"><?php echo $words["password"]?>: </td>
                                                    <td>
                                                        <input type="password" class="form-input" id="password" name="password" value="" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td valign="top" class="title"><?php echo $words["confirm password"]?>: </td>
                                                    <td>
                                                        <input type="password" class="form-input" id="repassword" name="repassword" value="" />
                                                    </td>
                                                </tr>
                                                                      <tr>
                                                    <td colspan="2"><br />
                                                         <center><input type="button" onClick="save_ajax()" value="<?php echo $words["submit"]?>" /></center>
                                                    </td>
                                                </tr>
                                            </table>
                                            </form> 
