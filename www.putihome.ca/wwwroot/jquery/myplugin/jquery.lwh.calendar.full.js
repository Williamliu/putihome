...
LWH.CALENDAR.prototype = {
	...
	month_desc: 	["January (一月)", "February (二月)", "March (三月)", "April (四月)", "May (五月)", "June (六月)", "July (七月)", "August (八月)", "September (九月)", "October (十月)", "November (十一月)", "December (十二月)"],
	...
	toHTML: function() {
		...
		html += '<tr >';
		html += '<td class="title" width="200">Sunday (日)</td>';
		html += '<td class="title" width="200">Monday (一)</td>';
		html += '<td class="title" width="200">Tuesday (二)</td>';
		html += '<td class="title" width="200">Wednesday (三)</td>';
		html += '<td class="title" width="200">Thursday (四)</td>';
		html += '<td class="title" width="200">Friday (五)</td>';
		html += '<td class="title" width="200">Saturday (六)</td>';
		html += '</tr>';
